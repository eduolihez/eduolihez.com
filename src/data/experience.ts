...
export const experiences: Experience[] = [
  {
    ...
    current: true,
    description: {
      es: 'Triage de alertas con Trend Micro Vision One (TrendAI), investigacion de amenazas asistida por IA, automatizacion de informes en Python y diseno de campanas de phishing y concienciacion.',
  ...
  },
  {
    ...
    description: {
      es: 'Administracion y monitorizacion de FortiGate y FortiAnalyzer, respuesta a incidentes de nivel 1 y 2, y desarrollo de scripts de seguridad en Python.',
  ...
  },
  {
    ...
    description: {
      es: 'Soporte tecnico a mas de 100 usuarios, administracion de Active Directory y automatizacion de tareas con scripts en Python.',
  ...
  },
  {
    ...
    description: {
      es: 'Liderazgo de grupos, comunicacion y gestion de personas: habilidades transferibles clave para el trabajo en equipo y la comunicacion de un SOC.',
