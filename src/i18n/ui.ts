...
export const ui = {
  es: {
    ...
    'cv.modal.body': 'Mi currículum está siendo actualizado en este momento, por lo que no está disponible para descarga directa. Si necesitas información sobre mi perfil, escríbeme a eduardo@eduolihez.com o échale un vistazo a mi LinkedIn, que está SIEMPRE actualizado.',
    'cv.modal.linkedin': 'Ver mi LinkedIn',
    'cv.modal.email': 'Enviar email',
  ...
  en: {
    ...
    'cv.modal.body': 'My CV is currently being updated, so it is temporarily unavailable for direct download. If you need more information about my profile, email me at eduardo@eduolihez.com or check out my LinkedIn, which is ALWAYS kept up to date.',
    'cv.modal.linkedin': 'View my LinkedIn',
    'cv.modal.email': 'Send email',
  ...
  ca: {
    ...
    'cv.modal.body': "El meu currículum s'està actualitzant en aquest moment, per la qual cosa no està disponible per a la descàrrega directa. Si necessites informació sobre el meu perfil, escriu-me a eduardo@eduolihez.com o fes un cop d'ull al meu LinkedIn, que està SEMPRE actualitzat.",
    'cv.modal.linkedin': 'Veure el meu LinkedIn',
    'cv.modal.email': 'Enviar correu',
